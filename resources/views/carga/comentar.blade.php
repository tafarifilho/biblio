...
@section('content')
	...
	{!! Form::open(array('route'=>'carga.comentar.post', 'class' => 'form-horizontal')) !!}
	...
	<div class="botao-flutuador">
		...
		<button type="button" class="btn btn-success btn-lg" data-toggle="modal" data-target="#comentarModal">
			<span class="glyphicon glyphicon-refresh" aria-hidden="true"></span> Comentar Carga
		</button>

		<div class="modal fade" id="comentarModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-sm">
				<div class="modal-content">

					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
						<h4 class="modal-title" id="myModalLabel">Comentar Carga</h4>
					</div>
					...
					<div class="modal-footer">
						...
						<button id="comentarCarga" type="submit" class="btn btn-primary">
							<span class="glyphicon glyphicon-edit" aria-hidden="true"></span> Comentar Carga
						</button>
...
@section('scripts')
	...
	{!! Html::script('js/comentarcarga.js') !!}
